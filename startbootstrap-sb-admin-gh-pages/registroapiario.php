            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">  
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">       
                            <a class="nav-link" href="../startbootstrap-sb-admin-gh-pages/inspeccion.html">Nueva inspección</a>
                      ...
                      <form method="post">
                        <div class="row mb-20">
                          <div class="mb-4">
                            <div class="form-floating mb-3 mb-md-0">
                              <input type="text" name="apiario" class="form-control" id="inputFirstName" 
                                placeholder="apiario" />
                          ...
                          <div class="mb-4">
                            <div class="form-floating">
                              <input type="text" name="lugar"  class="form-control" id="inputLastName" type="text"
                                placeholder="lugar" />
                        ...
                        <div class="form-floating mb-3">
                          ...
                          <div class="mb-4">
                            ...
                            <input type="date" name="fecha" id="start" name="trip_start" value="2020-07-22" min="2020-01-01"
                              max="2040-12-31" />
                          </div>
                        <!--  <div class="mb-4">
                            <div class="form-floating mb-3 mb-md-0">
                          ...
                          <div class="mb-4">
                            <div class="form-floating mb-3 mb-md-0">
                              ...
                              <div id="map" class="">
                                <iframe class="container w-20 "
                                  src="https://www.google.com/maps/embed?pb=!1m23!1m12!1m3!1d67233.74432444666!2d-73.39777320584164!3d8.201766435372056!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m8!3e6!4m0!4m5!1s0x8e677b971d6d1fd1%3A0xf3eeb5f83fb498c9!2sOca%C3%B1a%2C%20Norte%20de%20Santander!3m2!1d8.238693699999999!2d-73.3472901!5e0!3m2!1ses!2sco!4v1708614666410!5m2!1ses!2sco"
