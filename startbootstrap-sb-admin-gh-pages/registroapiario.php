                  ...
                  <div class="card-body">
                    <form action="" method="post">
                      <div class="row mb-20">
                        ...
                        <div class="mb-4">
                          <div class="form-floating">
                            <input type="text" name="lugar" class="form-control" id="inputLastName" type="text" placeholder="lugar" />
                      ...
                      <div class="mb-4">
                        ...
                        <input type="date" name="fecha" id="start" name="trip_start" value="2020-07-22" min="2020-01-01" max="2040-12-31" />
                      </div>
                      <!--  <div class="mb-4">
                            <div class="form-floating mb-3 mb-md-0">
