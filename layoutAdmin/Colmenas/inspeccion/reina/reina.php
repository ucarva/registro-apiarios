                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    ...
                                    <div class="container">
                                        ...
                                        <form action="reina.php" method="post">
                                            <div class="mb-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" name="raza" class="form-control  " id="inputFirstName" placeholder="Raza" />

                                                </div>
                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Linea:</label>
                                                    <input type="text" name="linea" class="form-control  " id="inputFirstName" placeholder="Linea" />

                                                </div>
                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Numero:</label>
                                                    <input type="text" name="numero" class="form-control  " id="inputFirstName" placeholder="Numero" />

                                                </div>
                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Fuente:</label>
                                                    <select id="inputState" name="fuente" class="form-select">
                                                        <option selected>Comprada</option>
                                                        <option selected>Atrapada</option>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select id="inputState" name="postura" class="form-select">
                                                        ...
                                                        <option selected>Muy Buena</option>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <select id="inputState" name="ciclo" class="form-select">
                                                        <option selected>Realera</option>
                                                        <option selected>Eclosión</option>
                                                        <option selected>Fecundación</option>
                                                        <option selected>Joven</option>
