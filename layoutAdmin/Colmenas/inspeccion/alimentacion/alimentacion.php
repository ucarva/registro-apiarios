                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    ...
                                    <div class="container">
                                        ...
                                        <?php
                                        include "conexionalimentacion.php";
                                        ...
                                        <form action="alimentacion.php" method="post">
                                            <div class="mb-3">
                                                ...
                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Jarabe:</label>
                                                    <select id="inputState" name="jarabe" class="form-select">
                                                        <option selected>concentración: 1:1</option>
                                                        <option selected>concentración: 2:1</option>
                                                        <option selected>concentración: 3:2</option>
                                                        <option selected>concentración: otro</option>
                                                        
                                                    </select>
                                                </div>

                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Azucar invertido:</label>
                                                    <input type="text" name="azucar" class="form-control  " id="inputFirstName" placeholder="Cantidad (KG)" />

                                                </div>

                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Candy board:</label>
                                                    <input type="text" name="board" class="form-control  " id="inputFirstName" placeholder="Cantidad (KG)" />

                                                </div>

                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Candy:</label>
                                                    <input type="text" name="candy" class="form-control  " id="inputFirstName" placeholder="Cantidad (KG)" />

                                                </div>

                                                <div class="col-12">
                                                    <label for="inputState" class="form-label">Otros:</label>
                                                    <input type="text" name="otro" class="form-control  " id="inputFirstName" placeholder="Cantidad (KG)" />
